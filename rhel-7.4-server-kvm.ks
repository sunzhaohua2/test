...
bootloader --timeout=1 --location=mbr --append="console=tty0"
...
# url --url=http://download.devel.redhat.com/nightly/latest-RHEL-7/compose/Everything/x86_64/os/
...
#repo --name="rhel7" --baseurl=http://download.devel.redhat.com/nightly/latest-RHEL-7/compose/Everything/x86_64/os/
#repo --name="rhel7-opt" --baseurl=http://download.devel.redhat.com/nightly/latest-RHEL-7/compose/Everything-optional/x86_64/os/
#repo --name="cloud" --baseurl=http://download.devel.redhat.com/brewroot/repos/images-rhel-7.0-build/latest/x86_64/
